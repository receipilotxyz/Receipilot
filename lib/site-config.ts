...
export const siteConfig = {
  ...
  // ── Images ─────────────────────────────────────────────────
  // To change: replace the file in /public/ with the same name,
  // or update the path below to point to your new file.
  ...
  hero: {
    ...
    subheadline:
      'Transform any online purchase email into a cryptographically verified NFT in seconds. Impossible to fake, forever on-chain.',
    pills: ['DKIM Verified', 'Instant Mint', 'On-Chain Forever'],
    stats: [
  ...
  cta: {
    ...
    subtitle:
      'Join thousands of users protecting their purchases with cryptographic proof. Start minting your receipt NFTs today.',
    perks: ['No credit card', '2 free mints/week', 'Zero gas fees'],
  },
  ...
  footer: {
    description:
      'Transform online purchase emails into cryptographically verified NFTs. Impossible to fake, forever on-chain.',
